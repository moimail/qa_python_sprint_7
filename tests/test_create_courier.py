...
@allure.suite("Ручка /api/v1/courier")
class TestCreateCourier:
    @allure.title("Создание курьера с корректными данными.")
    @allure.description(" Получаем код 200 и сообщение 'ок':true")
    ...
    @allure.title("Проверка нвозможности создании курьера с существующим логином.")
    @allure.description(" Получаем ошибку 409")
    ...
    @allure.title("Проверка невозможности создании курьера, когда одно из полей незаполненно.")
    @allure.description("Получаем ошибку 400")
